...
## Features
- Implements superposition analysis
...
```bash
git clone https://github.com/klindtlab/MachInterp.git
cd MachInterp
...
## Examples
Please refer to the `example.ipynb` jupyter notebook in the `examples` directory.
